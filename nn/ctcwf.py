...
batch_size = 11025*5 # length of a sample training piece within a song in terms of number of frames
...
def train_lstm(
    ...
    try:
        for eidx in xrange(max_epochs):
            ...
            n_samples += 1
            # FIXME: use numpy.expand_dimes to expand x's dimension to be (500L,1L)
            # so that x can be dot product with lstm_W (1L,500L)
