...
pkl_data_framewise('../data/Jsong-ch-inv.mat','../data/Jsong-ch-inv.pkl')
pkl_data_nseg('../data/Jsong-ch-inv.mat','../data/Jsong-6seg-ch-inv.pkl',6)
...
pkl_data_varlen('../data/J6varlen-ch-inv.mat','../data/J6varlen-ch-inv.pkl',24,1)
pkl_data_varlen('../data/J6varlen-ch-noinv.mat','../data/J6varlen-ch-noinv.pkl',24,1)
pkl_data_varlen('../data/B6varlen-ch-inv.mat','../data/B6varlen-ch-inv.pkl',24,1)
pkl_data_varlen('../data/B6varlen-ch-noinv.mat','../data/B6varlen-ch-noinv.pkl',24,1)