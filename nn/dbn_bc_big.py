...
class DBN(object):
    ...
    def pretraining_functions(self, train_set_x, batch_size, cdk, usepersistent):
        ...
        for rbm in self.rbm_layers:
            ...
            fn = theano.function(
                inputs=[bc_idx, theano.Param(learning_rate, default=0.1)],
                outputs=cost,
                updates=updates,
                givens={
...
def test_DBN(finetune_lr, pretraining_epochs,
    ...
    datasets = loadmat(dataset=dataset, shuffle=shuffle, datasel=datasel, scaling=scaling, robust=robust, h5py=1)
    train_set_x, train_set_y = datasets[0]
    valid_set_x, valid_set_y = datasets[1]
    test_set_x, test_set_y = datasets[2]
    ...
    for i in xrange(dbn.n_layers):
        ...
        for epoch in xrange(pretraining_epochs):
            ...
            for batch_index in xrange(n_train_batches):
                ...
                c.append(pretraining_fns[i](bc_idx=bc_idx,
                                            lr=pretrain_lr))
