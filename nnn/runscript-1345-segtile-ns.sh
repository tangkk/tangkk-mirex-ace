...
# THEANO_FLAGS="device=cuda2" python blstm.py ../data/cv/ JK-1345-ns-1seg ../data/cv/C-ns-1seg.mat 252 800
...
script log/log-blstm-JKU-1345-ns-1seg.txt -c "THEANO_FLAGS="device=cuda2" python blstm.py ../data/cv/ JKU-1345-ns-1seg ../data/cv/C-ns-1seg.mat 252 800"
...
script log/log-blstm-JKU-1345-ns-2seg.txt -c "THEANO_FLAGS="device=cuda2" python blstm.py ../data/cv/ JKU-1345-ns-2seg ../data/cv/C-ns-2seg.mat 252 800"
...
script log/log-blstm-JKU-1345-ns-3seg.txt -c "THEANO_FLAGS="device=cuda2" python blstm.py ../data/cv/ JKU-1345-ns-3seg ../data/cv/C-ns-3seg.mat 252 800"
...
script log/log-blstm-JKU-1345-ns-9seg.txt -c "THEANO_FLAGS="device=cuda2" python blstm.py ../data/cv/ JKU-1345-ns-9seg ../data/cv/C-ns-9seg.mat 252 800"
...
script log/log-blstm-JKU-1345-ns-12seg.txt -c "THEANO_FLAGS="device=cuda2" python blstm.py ../data/cv/ JKU-1345-ns-12seg ../data/cv/C-ns-12seg.mat 252 800"