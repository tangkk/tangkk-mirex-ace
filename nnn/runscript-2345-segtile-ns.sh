...
# THEANO_FLAGS="device=cuda3" python blstm.py ../data/cv/ JK-2345-ns-1seg ../data/cv/C-ns-1seg.mat 24 800
...
script log/log-blstm-JKU-2345-ns-1seg.txt -c "THEANO_FLAGS="device=cuda3" python blstm.py ../data/cv/ JKU-2345-ns-1seg ../data/cv/C-ns-1seg.mat 24 800"
...
script log/log-blstm-JKU-2345-ns-2seg.txt -c "THEANO_FLAGS="device=cuda3" python blstm.py ../data/cv/ JKU-2345-ns-2seg ../data/cv/C-ns-2seg.mat 24 800"
...
script log/log-blstm-JKU-2345-ns-3seg.txt -c "THEANO_FLAGS="device=cuda3" python blstm.py ../data/cv/ JKU-2345-ns-3seg ../data/cv/C-ns-3seg.mat 24 800"
...
script log/log-blstm-JKU-2345-ns-9seg.txt -c "THEANO_FLAGS="device=cuda3" python blstm.py ../data/cv/ JKU-2345-ns-9seg ../data/cv/C-ns-9seg.mat 24 800"
...
script log/log-blstm-JKU-2345-ns-12seg.txt -c "THEANO_FLAGS="device=cuda3" python blstm.py ../data/cv/ JKU-2345-ns-12seg ../data/cv/C-ns-12seg.mat 24 800"