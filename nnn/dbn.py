...
class DBN(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784,
        ...
        for i in xrange(self.n_layers):
            ...
            hiddenlayer = HiddenLayer(rng=numpy_rng,
                                        input=layer_input,
                                        n_in=input_size,
            ...
            # hiddenlayers are parameters of the DBN. The visible
    ...
    def build_finetune_functions(self, datasets, batch_size, learning_rate):
        ...
        return train_fn, train_score, valid_score
...
def test_DBN(finetune_lr, pretraining_epochs,
             ...
             L1_reg, L2_reg,
             hidden_layers_sizes,
             trainpath, trainlist, validset, batch_size, output_folder, shuffle, scaling, dropout, earlystop, first_layer, dumppath):
    """
    ...
    train_fn, train_model, validate_model = dbn.build_finetune_functions(
        datasets=datasets,
        batch_size=batch_size,
    ...
    if dropout:
        ...
        for i in range(dbn.n_layers):
            dbn.hiddenlayers[i].output = dropout_layer(use_noise, dbn.hiddenlayers[i].output, trng, 0.5)
...
#                       this_training_loss * 100.))
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    numpy.savez(dumppath, model=dbn.params, training_history=training_history,
...
if __name__ == '__main__':
    ...
    hidden_layers_sizes_ = sys.argv[4].split(',') #1000
    first_layer = sys.argv[5] #'grbm'
