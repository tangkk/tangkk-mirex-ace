...
def train_lstm(
    ...
    dumppath='../model/lstm_model.npz',  # The best model will be saved there
    ...
    #train, valid = loadmat(trainpath=trainpath,trainlist=trainlist,
    #                       validset=validset,dumppath=dumppath,caling=scaling)
    ...
    print 'Train ', train_err, 'Valid ', valid_err
    if dumppath:
        numpy.savez(dumppath, train_err=train_err,valid_err=valid_err,
