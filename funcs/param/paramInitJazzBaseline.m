...
function [feparam, beparam, dbnparam, dbn2param, chordmode] = paramInitJazzBaseline()
...
beparam = struct(...
    ...
    ...
    ...
    'enBassTrebleCorrect', 0,... % work together with 'noSegmentation'
    'enTheanoNN', 0,... % 1: type-I or type-II, switched by savetmp setting
    'btcVersion', 0);
dbnparam = struct(...
    'muCBass',1,...
    'muNCBass',1,...
