...
function dbn1_bias(n_hid, nclass, lr_rbm, lr_classification, mini_batch_size, n_iterations, name_dataset)
    % load data
...
%                      n_iterations);
    ...
    model = trainDNN1([size(data_sets.training.targets,1), n_hid+1], @(model_, data) d_loss_by_d_model_bias(model_, data, 0),...
