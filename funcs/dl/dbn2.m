...
function model = dbn2(n_hid_1, n_hid_2, nclass, lr_rbm, lr_classification, wd, mini_batch_size, n_iterations, name_dataset)
    % load data
...
%                      n_iterations);
    ...
    model = trainDNN2([size(data_sets.training.targets,1), n_hid_2], @(model_, data) d_loss_by_d_model_2(model_, data, wd),...
