% recompute bass-treble using the trained neural network param nn2(data-B-12-key.mat,120,544,1000,1)-62.84

function [rootgram, bassgram, treblegram] = bassTrebleCorrect12(rootgram,...
