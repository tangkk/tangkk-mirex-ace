% recompute bass-treble using the trained neural network param nn2(data-J-1-key.mat,100,500,1000,1)-76.76

function [rootgram, bassgram, treblegram] = bassTrebleCorrect7(rootgram,...
    bassgram, treblegram, basegram, uppergram, bdrys, chordmode)


nslices = size(rootgram,2);
load('nn2(data-J-1-key.mat,100,500,1000,1)-76.76.mat');
load('chordnames.mat');
