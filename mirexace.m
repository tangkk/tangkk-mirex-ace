...
[audiofolder, audiopath, cpfolder, cppath,...
    gtfolder, gtpath, tunpath, vamptunpath] = inputDecode(tline, codec);

display('frontend...');

[fs, nslices, endtime, S, btrack] = frontEndDecode(audiopath, tunpath, vamptunpath,...
    feparam, df, enPlotFE);
